...
const SEEDED_FALLBACK_INCIDENTS: Record<string, IncidentDetailRecord> = {
  ...
  '#8921': {
    incidentId: '#8921',
    title: 'AGORA ECHOSPHERE SEV-1 PAYMENT OUTAGE',
    severity: 'Critical',
    status: 'INVESTIGATING',
    lead: 'Ashley Sawatsky',
    reporter: 'Datadog Ingress Monitor',
    participants: ['Ashley Sawatsky', 'David Chen', 'Sarah Connor', 'Meera Patel', 'EchoSphere Sentinel'],
    slackChannel: '#incident-8921',
    jiraKey: 'PAY-891',
    problem:
      'Payment processing error rate spiked to 47.2% and p99 latency surged to 6.2 seconds across checkout authorization endpoints.',
    impact:
      'Approximately 1,420 checkout attempts per minute failing with HTTP 504 timeouts. Estimated revenue risk at $14,200/min.',
    causes:
      'Synchronous client socket backlog saturation in downstream fraud-detection-svc triggered following deployment of payment-service:v2.8.1.',
    mitigation:
      'Executed canary rollback to payment-service:v2.8.0, paged Fraud SRE on-call for socket pool adjustments, and published customer status updates.',
    createdAt: Date.now() - 3600 * 1000 * 1.5,
    durationString: 'Active for 1h 30m',
    affectedTeam: 'Payments & Checkout Infrastructure',
    reviewer: 'Ashley Sawatsky',
    timelineEvents: [
      {
        id: 'evt-8921-1',
        timestamp: Date.now() - 3600 * 1000 * 1.5,
        timeFormatted: '15:15 UTC',
        type: 'declared',
        title: 'Datadog Alert: p99 Checkout Latency > 5000ms',
        description: 'Automated monitor fired; ingress error rate exceeded 40% threshold.',
        author: 'Datadog APM',
      },
      {
        id: 'evt-8921-2',
        timestamp: Date.now() - 3600 * 1000 * 1.4,
        timeFormatted: '15:20 UTC',
        type: 'lead_assigned',
        title: 'Ashley Sawatsky assumed Incident Commander role',
        description: 'Acknowledged PagerDuty high-urgency page and initiated Agora War Room bridge.',
        author: 'Ashley Sawatsky',
      },
      {
        id: 'evt-8921-3',
        timestamp: Date.now() - 3600 * 1000 * 1.0,
        timeFormatted: '15:40 UTC',
        type: 'ledger_fact',
        title: '[FACT] Payment 5xx rate 47.2% | Latency 6.2s',
        description: 'Ingress latency 6.2s, 1,420 checkout failures/min confirmed in voice triage.',
        author: 'Ashley Sawatsky (Agora War Room)',
      },
      {
        id: 'evt-8921-4',
        timestamp: Date.now() - 3600 * 1000 * 0.8,
        timeFormatted: '15:43 UTC',
        type: 'ledger_hypothesis',
        title: '[HYPOTHESIS] v2.8.1 Worker Thread Memory Leak',
        description: 'David Chen hypothesized recursive retry memory leak in v2.8.1 orchestrator.',
        author: 'David Chen (Agora War Room)',
      },
      {
        id: 'evt-8921-5',
        timestamp: Date.now() - 3600 * 1000 * 0.6,
        timeFormatted: '15:45 UTC',
        type: 'ledger_fact',
        title: '[CONTRADICTION] HolmesGPT: DB Pool 22%, Pod Memory 58%',
        description: 'Telemetry disproves memory leak. Pod memory is stable at 58% and DB leases at 22%.',
        author: 'David Chen (HolmesGPT)',
      },
      {
        id: 'evt-8921-6',
        timestamp: Date.now() - 3600 * 1000 * 0.4,
        timeFormatted: '15:47 UTC',
        type: 'ledger_fact',
        title: '[FACT] Root Cause: fraud-detection-svc Socket Timeout (45%)',
        description: 'Downstream distributed trace confirms socket backlog saturation.',
        author: 'David Chen (Agora War Room)',
      },
      {
        id: 'evt-8921-7',
        timestamp: Date.now() - 3600 * 1000 * 0.2,
        timeFormatted: '15:50 UTC',
        type: 'ledger_action',
        title: '[ACTION] Canary Rollback, Page Fraud SRE, Broadcast Comms',
        description: 'Commander delegated rollback to v2.8.0, paged Meera Patel, and scheduled stakeholder update.',
        author: 'Ashley Sawatsky (Agora War Room)',
      },
    ],
    actions: [
      ...
      {
        id: 'act-2',
        title: 'Page Fraud SRE on-call (Meera Patel) for socket timeout saturation',
        completed: false,
        assignee: 'Ashley Sawatsky',
        createdAt: Date.now() - 3600 * 1000 * 0.3,
      },
      {
        id: 'act-3',
        title: 'Broadcast customer-facing status update on status.acme.com and Slack',
        completed: false,
        assignee: 'Sarah Connor',
        createdAt: Date.now() - 3600 * 1000 * 0.3,
      },
    ...
    followUps: [
      {
        id: 'fup-1',
        title: 'Implement asynchronous circuit breaker on fraud-detection-svc client',
        priority: 'High',
        status: 'In Progress',
        jiraKey: 'PAY-891',
        owner: 'David Chen',
      ...
      {
        id: 'fup-2',
        title: 'Tune Kubernetes TCP SYN backlog and socket keep-alive buffers',
        priority: 'High',
        status: 'Open',
        jiraKey: 'INFRA-442',
        owner: 'Meera Patel',
