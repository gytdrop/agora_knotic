      ...
      <div className="flex items-center gap-3 flex-1 min-w-[280px] max-w-xl">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-8 pr-8 py-1.5 text-xs text-zinc-900 placeholder-zinc-400 bg-zinc-50 hover:bg-zinc-100/60 focus:bg-white border border-zinc-200 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-md transition-colors outline-none"
          />
          {searchQuery && (
            <button
              type="button"
